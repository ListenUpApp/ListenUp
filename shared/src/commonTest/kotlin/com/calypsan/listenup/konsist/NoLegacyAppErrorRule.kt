 ...
 * deletion ([com.calypsan.listenup.client.core.error.ErrorBus],
                ...
                file.imports
                    .filter { import ->
                        import.name.startsWith("com.calypsan.listenup.client.core.error.") &&
                            allowedSurvivors.none { allowed -> import.name == allowed || import.name.startsWith("$allowed.") }
                    }
