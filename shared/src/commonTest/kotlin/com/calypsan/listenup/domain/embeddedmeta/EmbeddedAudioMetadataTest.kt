...
class EmbeddedAudioMetadataTest : FunSpec({
    val json = Json {}
            ...
            EmbeddedAudioMetadata(
                ...
                tags =
                    AudioTags(
                        ...
                        genres = listOf("Fantasy"), description = null, publisher = null,
                        publishedYear = 2010, asin = null, isbn = null, language = "en",
                        trackNumber = null, discNumber = null, custom = emptyMap(),
                    ),
                chapters =
                    listOf(
