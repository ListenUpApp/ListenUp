...
enum class BookField(
    ...
    SORT_TITLE(MetadataDomain.BOOK_CORE),
    ...
    ISBN(MetadataDomain.BOOK_CORE),
    ASIN(MetadataDomain.BOOK_CORE),
    ABRIDGED(MetadataDomain.BOOK_CORE),
    EXPLICIT(MetadataDomain.BOOK_CORE),
