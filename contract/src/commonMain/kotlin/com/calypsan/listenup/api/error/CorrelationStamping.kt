 ...
 * [PlaybackError]) are delegated to [leafWithCorrelationId]; [LibraryError]/[LibraryWriteError]
 * delegate to [libraryFamilyWithCorrelationId] and [ShelfError]/[SocialError]/[ReadingOrderError]
 * to [shelfOrSocialWithCorrelationId] — all to keep the cyclomatic complexity of this function
 * under the project threshold of 25.
 */
public fun AppError.withCorrelationId(id: String?): AppError =
    when (this) {
        ...
        is ShelfError, is SocialError, is ReadingOrderError -> shelfOrSocialWithCorrelationId(id)
        ...
        is CampfireError -> withCorrelationId(id)
 ...
 * [withCorrelationId] to each family's own exhaustive `copy`. Split out solely to keep
