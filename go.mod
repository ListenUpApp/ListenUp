...
require (
	buf.build/gen/go/listenup/listenup/grpc/go v1.5.1-20240821015425-b0d994e31836.1
	buf.build/gen/go/listenup/listenup/protocolbuffers/go v1.34.2-20240821015425-b0d994e31836.2
