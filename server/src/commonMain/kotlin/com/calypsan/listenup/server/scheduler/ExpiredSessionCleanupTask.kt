...
internal class ExpiredSessionCleanupTask(
    ...
    private suspend fun untilNextSweep(): Duration =
        ...
        }.onFailure { log.warn(it) { "ExpiredSessionCleanupTask could not read its last run; sweeping now" } }
    ...
    internal companion object {
        ...
        const val LAST_RUN_KEY = "scheduler.expiredSessionCleanup.lastRunAtMs"
