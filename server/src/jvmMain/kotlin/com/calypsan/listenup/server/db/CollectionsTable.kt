 ...
 *
 * The system-managed inbox collection for a library is identified by [type] `= 'INBOX'` —
 * at most one live inbox per library is enforced by a partial unique index on [libraryId]
 * in the migration (`idx_collections_inbox WHERE type = 'INBOX' AND deleted_at IS NULL`).
