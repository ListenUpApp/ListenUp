...
private fun BookDetailReadyContent(
    ...
    BookDetailContent(
        ...
        // Defense-in-depth: the affordance is already gated on isAdmin in BookActionsMenu, but the
        // handler double-checks so a stale/leaked visibility state can never trigger the navigation.
        onEditChaptersClick = { if (state.isAdmin) onEditChaptersClick(bookId) },
