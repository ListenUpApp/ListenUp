 ...
 *
 * **Why it now covers `:contract` too.** It used to be scoped to `:app:sharedLogic`, excluding `:contract`
 ...
 * (`com.calypsan.listenup.core`), which `:app:sharedLogic` re-exports via `api(projects.contract)`, so both
