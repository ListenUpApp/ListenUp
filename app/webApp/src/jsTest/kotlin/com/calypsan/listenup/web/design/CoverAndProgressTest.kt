...
class CoverAndProgressTest :
    FunSpec({
        ...
        test("a cover with artwork renders the image") {
            val host = mounts.mount { Cover(title = "The Institute", imageUrl = "/api/v1/books/x/cover") }
        ...
        test("a cover without artwork falls back to a generated tile carrying the title") {
            val host = mounts.mount { Cover(title = "The Institute") }
        ...
        test("the generated cover is stable for a given title") {
            ...
            val first = mounts.mount { Cover(title = "Project Hail Mary") }
            val second = mounts.mount { Cover(title = "Project Hail Mary") }
        ...
        test("different titles get different generated covers") {
            val a = mounts.mount { Cover(title = "The Institute") }
            val b = mounts.mount { Cover(title = "Project Hail Mary") }
        ...
        test("a cover too small to hold a title legibly shows the gradient alone") {
            ...
            val host = mounts.mount { Cover(title = "The Way of Kings", size = 56) }
        ...
        test("a cover is square whatever size it is asked for") {
            val host = mounts.mount { Cover(title = "The Institute", size = 140) }
        ...
        test("the book-edit cover frame is square, so the preview is not a crop of its own") {
            val host = mounts.mount { Div(attrs = { classes("cover-art") }) {} }
