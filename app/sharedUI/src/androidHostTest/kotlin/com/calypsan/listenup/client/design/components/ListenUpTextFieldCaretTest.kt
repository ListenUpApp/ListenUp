...
private fun SemanticsNodeInteraction.assertSelection(
    expected: TextRange,
): SemanticsNodeInteraction = assert(SemanticsMatcher.expectValue(SemanticsProperties.TextSelectionRange, expected))
