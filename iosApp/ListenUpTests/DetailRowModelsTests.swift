...
struct DetailRowModelsTests {
    @Test func bookRowCarriesDurationAndSequence() {
        let row = BookRow(
            ...
            hasDocuments: false, coverPath: nil, coverBlurHash: nil,
    ...
    @Test func roleSectionRowIsKeyedByRoleAndHoldsItsBooks() {
        let books = [
            BookRow(id: "1", title: "One", authorNames: "", hasDocuments: false, coverPath: nil, coverBlurHash: nil),
            BookRow(id: "2", title: "Two", authorNames: "", hasDocuments: false, coverPath: nil, coverBlurHash: nil)
        ]
