...
tasks.named<Test>("jvmTest") {
    ...
    // 4g stopped being enough when the trunk and feature lines merged (the union tree grew the PSI
    // scope + the e2e surface together); 6g matches the Kotlin daemon's ceiling.
    maxHeapSize = "6g"
