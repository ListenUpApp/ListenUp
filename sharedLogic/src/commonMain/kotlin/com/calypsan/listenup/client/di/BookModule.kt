 ...
 *  - [com.calypsan.listenup.client.domain.repository.GenreRepository] — `syncModule`
 *  - [com.calypsan.listenup.client.domain.repository.TagRepository] — `syncModule`
 *  - [com.calypsan.listenup.client.data.remote.CollectionRpcFactory] — `syncModule`
