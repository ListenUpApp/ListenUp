...
func (ac *AuthorCreate) SetNillableDescription(s *string) *AuthorCreate {
	if s != nil {
		ac.SetDescription(*s)
	}
	return ac
...
func (ac *AuthorCreate) SetImagePath(s string) *AuthorCreate {
	ac.mutation.SetImagePath(s)
	return ac
}

// SetNillableImagePath sets the "image_path" field if the given value is not nil.
func (ac *AuthorCreate) SetNillableImagePath(s *string) *AuthorCreate {
	if s != nil {
		ac.SetImagePath(*s)
	}
	return ac
...
func (ac *AuthorCreate) SetID(s string) *AuthorCreate {
	ac.mutation.SetID(s)
	return ac
}

// SetNillableID sets the "id" field if the given value is not nil.
func (ac *AuthorCreate) SetNillableID(s *string) *AuthorCreate {
	if s != nil {
		ac.SetID(*s)
	}
	return ac
...
func (ac *AuthorCreate) createSpec() (*Author, *sqlgraph.CreateSpec) {
	...
	if value, ok := ac.mutation.ImagePath(); ok {
