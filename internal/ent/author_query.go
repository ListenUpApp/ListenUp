...
func (aq *AuthorQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (aq *AuthorQuery) FirstIDX(ctx context.Context) string {
...
func (aq *AuthorQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (aq *AuthorQuery) OnlyIDX(ctx context.Context) string {
...
func (aq *AuthorQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (aq *AuthorQuery) IDsX(ctx context.Context) []string {
	ids, err := aq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (aq *AuthorQuery) loadBooks(ctx context.Context, query *BookQuery, nodes []*Author, init func(*Author), assign func(*Author, *Book)) error {
	...
	byID := make(map[string]*Author)
	nids := make(map[string]map[*Author]struct{})
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Where(sql.InValues(joinT.C(author.BooksPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(author.BooksPrimaryKey[0]))
...
func (aq *AuthorQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(author.Table, author.Columns, sqlgraph.NewFieldSpec(author.FieldID, field.TypeString))
	_spec.From = aq.sql
