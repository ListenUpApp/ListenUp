...
const (
	// Label holds the string label denoting the narrator type in the database.
	Label = "narrator"
...
var (
	...
	BooksPrimaryKey = []string{"narrator_id", "book_id"}
)
...
// OrderOption defines the ordering options for the Narrator queries.
