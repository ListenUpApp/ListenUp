...
func NameSort(v string) predicate.Series {
	return predicate.Series(sql.FieldEQ(FieldNameSort, v))
}
...
func NameSortEQ(v string) predicate.Series {
	return predicate.Series(sql.FieldEQ(FieldNameSort, v))
}

// NameSortNEQ applies the NEQ predicate on the "name_sort" field.
func NameSortNEQ(v string) predicate.Series {
	return predicate.Series(sql.FieldNEQ(FieldNameSort, v))
}

// NameSortIn applies the In predicate on the "name_sort" field.
func NameSortIn(vs ...string) predicate.Series {
	return predicate.Series(sql.FieldIn(FieldNameSort, vs...))
}

// NameSortNotIn applies the NotIn predicate on the "name_sort" field.
func NameSortNotIn(vs ...string) predicate.Series {
	return predicate.Series(sql.FieldNotIn(FieldNameSort, vs...))
}

// NameSortGT applies the GT predicate on the "name_sort" field.
func NameSortGT(v string) predicate.Series {
	return predicate.Series(sql.FieldGT(FieldNameSort, v))
}

// NameSortGTE applies the GTE predicate on the "name_sort" field.
func NameSortGTE(v string) predicate.Series {
	return predicate.Series(sql.FieldGTE(FieldNameSort, v))
}

// NameSortLT applies the LT predicate on the "name_sort" field.
func NameSortLT(v string) predicate.Series {
	return predicate.Series(sql.FieldLT(FieldNameSort, v))
}

// NameSortLTE applies the LTE predicate on the "name_sort" field.
func NameSortLTE(v string) predicate.Series {
	return predicate.Series(sql.FieldLTE(FieldNameSort, v))
}

// NameSortContains applies the Contains predicate on the "name_sort" field.
func NameSortContains(v string) predicate.Series {
	return predicate.Series(sql.FieldContains(FieldNameSort, v))
}

// NameSortHasPrefix applies the HasPrefix predicate on the "name_sort" field.
func NameSortHasPrefix(v string) predicate.Series {
	return predicate.Series(sql.FieldHasPrefix(FieldNameSort, v))
}

// NameSortHasSuffix applies the HasSuffix predicate on the "name_sort" field.
func NameSortHasSuffix(v string) predicate.Series {
	return predicate.Series(sql.FieldHasSuffix(FieldNameSort, v))
}

// NameSortEqualFold applies the EqualFold predicate on the "name_sort" field.
func NameSortEqualFold(v string) predicate.Series {
	return predicate.Series(sql.FieldEqualFold(FieldNameSort, v))
}

// NameSortContainsFold applies the ContainsFold predicate on the "name_sort" field.
func NameSortContainsFold(v string) predicate.Series {
	return predicate.Series(sql.FieldContainsFold(FieldNameSort, v))
}
