...
func (sq *SeriesQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (sq *SeriesQuery) FirstIDX(ctx context.Context) string {
...
func (sq *SeriesQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (sq *SeriesQuery) OnlyIDX(ctx context.Context) string {
...
func (sq *SeriesQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (sq *SeriesQuery) IDsX(ctx context.Context) []string {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (sq *SeriesQuery) loadSeriesBooks(ctx context.Context, query *SeriesBookQuery, nodes []*Series, init func(*Series), assign func(*Series, *SeriesBook)) error {
	...
	for _, n := range neighbors {
		fk := n.series_series_books
		if fk == nil {
			return fmt.Errorf(`foreign-key "series_series_books" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "series_series_books" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
