...
func (m metadataDSF) Subtitle() string {
	return m.id3.Subtitle()
}

func (m metadataDSF) Publisher() string {
	return m.id3.Publisher()
}

func (m metadataDSF) Series() string {
	return m.id3.Series()
}

func (m metadataDSF) SeriesSequence() string {
	return m.id3.SeriesSequence()
}

func (m metadataDSF) Language() string {
	return m.id3.Language()
}

func (m metadataDSF) ISBN() string {
	return m.id3.ISBN()
}

func (m metadataDSF) ASIN() string {
	return m.id3.ASIN()
}

func (m metadataDSF) Narrators() []string {
	return m.id3.Narrators()
}

func (m metadataDSF) Chapters() []Chapter {
	return m.id3.Chapters()
}
