...
// TODO let's make sure these work properly
func (m *metadataVorbis) Subtitle() string {
	return m.c["subtitle"]
}

func (m *metadataVorbis) Publisher() string {
	if m.c["publisher"] != "" {
		return m.c["publisher"]
	}
	return m.c["organization"]
}

func (m *metadataVorbis) Series() string {
	if m.c["series"] != "" {
		return m.c["series"]
	}
	return m.c["albumseries"]
}

func (m *metadataVorbis) SeriesSequence() string {
	if m.c["seriespart"] != "" {
		return m.c["seriespart"]
	}
	return m.c["seriessequence"]
}
...
func (m *metadataVorbis) ISBN() string {
	return m.c["isbn"]
}

func (m *metadataVorbis) ASIN() string {
	return m.c["asin"]
}

func (m *metadataVorbis) Narrators() []string {
	if m.c["narrator"] != "" {
		return []string{m.c["narrator"]}
	}
	if m.c["performer"] != "" {
		return []string{m.c["performer"]}
	}
	return nil
}
